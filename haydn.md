...
### Installation Guide for Redmi K40 Pro/Pro+/Mi 11i/Mi 11X Pro (haydn)
...
3. Download the Recovery from the link below:
   - **Recovery Link [ For Android 16 ]:** [Recovery](https://projectelixiros.com/device/haydn)
...
### Step 3: Boot into Recovery using Fastboot
...
4. Now, boot into Recovery using the following command:
```
...
2. Now tap Wipe, then Format data and continue with the formatting process.
> [!CAUTION]
> In some cases you need to wipe metadata before format or else it gives error so if it does then just go to Wipe then select metadata and wipe it.
...
6. On the device, select “Advanced”, then “ADB sideload” to begin sideload.
...
> [!Important]
> **May Required Files:**
> * Android 16 Recovery Link : [Tap here for link](https://projectelixiros.com/device/haydn)
