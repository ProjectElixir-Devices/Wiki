...
### Installation Guide for  Poco F5 / Redmi Note 12T (Marble)
...
> * For any queries or help related to Elixir, join our support group : [Tap Here](https://t.me/chaitanyabuilds)
...
2. Download the Recovery from the link below:
   - **Recovery Link**: [Tap here to download](https://github.com/Ctapchuk/android_device_xiaomi_marble-OFRP/releases/download/2025-02-15/OFRP-R11.1_7_RECOVERY-Beta-marble.img)
...
- Boot to Recovery - must use A15 recovery - link below
- Wipe Dalvik/Cache, Metadata, cache, data, FRP, metadata
- Flash the Rom
...
> [!Important]
> - A15 recovery: [Tap here for link](https://github.com/Ctapchuk/android_device_xiaomi_marble-OFRP/releases/download/2025-02-15/OFRP-R11.1_7_RECOVERY-Beta-marble.img)
> - Flash [This](https://sourceforge.net/projects/marble-builds/files/losksunext/) For kernelSU-Next also check which date to flash according to changelogs
...
> - Firmware is not required it's shipped with rom now
