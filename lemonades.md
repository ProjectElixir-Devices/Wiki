...
### Installation Guide For Project Elixir on Oneplus 9R(Lemonades)
> [!CAUTION]
...
4. Download any required Firmware files(Optional),required when your device is not on OOS 13.1.0.583(EX01) version
...
> If you are not on the mentioned firware, sideload the firmware after flashing the recovery then proceed to flash the rom 
