...
### Installation Guide for POCO X3/NFC (surya)
...
2. Download the Recovery from the link below:
   - **Recovery Link [ For Android 16 ]:** [Recovery](https://projectelixiros.com/device/surya)

3. Download the Project Elixir ROM for from a reliable source.
   - **Project Elixir ROM Link**: [DOWNLOAD](https://projectelixiros.com/device/surya)
