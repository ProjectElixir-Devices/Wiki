...
2. Download the Project Elixir ROM for from a reliable source.
   - **Project Elixir ROM Link**: [DOWNLOAD](https://projectelixiros.com/device/fajita)

3. Download the Recovery/Boot/other required files:
   - **Reqired files Link [ For Android 16 ]:** [Tap Here](https://projectelixiros.com/device/fajita)
...
1. Download Elixir Recovery. Simply download the latest recovery file named **boot.img** from the link provided in Step 1.
> [!Tip]
