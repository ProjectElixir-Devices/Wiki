...
### Installation Guide for Pixel 6 (oriole)
...
2. Download the Project Elixir ROM for from a reliable source.
   - **Project Elixir ROM Link**: [DOWNLOAD](https://projectelixiros.com/device/oriole)

3. Download the Recovery/Boot/other required files:
   - **Reqired files Link [ For Android 16 ]:** [Tap Here](https://projectelixiros.com/device/oriole)
