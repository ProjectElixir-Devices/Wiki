...
### Installation Guide For Project Elixir on Oneplus 8T(Kebab)
> [!CAUTION]
...
4. Download any required Firmware files(Optional),required when your device is not on OOS 13.1.0.582(EX01) version
   - **Firmware Link**: [Here](https://mega.nz/folder/W7JhwTAT#Yu6cxqvJcAC28cy0m_kkQA)
...
> If you are not on the mentioned firmware, sideload the firmware after flashing the recovery after which proceed to flash then ROM
