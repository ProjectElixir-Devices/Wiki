...
### Installation Guide for Oneplus 8T (kebab)
...
2. Download the Project Elixir ROM for from a reliable source.
   - **Project Elixir ROM Link**: [DOWNLOAD](https://projectelixiros.com/device/kebab)

3. Download the Recovery/Boot/other required files:
   - **Reqired files Link [ For Android 15 ]:** [Tap Here](https://projectelixiros.com/device/kebab)
