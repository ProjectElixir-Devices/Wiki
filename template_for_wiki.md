...
> * Be careful while going through download, installation guide, changelog links as A12 = v2.0 (snow), A13 = v3.0 (Tiramisu) and A14 = v4.0 (UNO), A15 = 5.0 (vany) and A16 = 6.0 (bkl) respective branch.
...
2. Download the Recovery from the link below:
   - **Recovery Link [ For Android 16 ]:** [Recovery](https://projectelixiros.com/download)
...
> * Any Extra File link if required : [Tap Here for link](https://projectelixiros.com/archive)
