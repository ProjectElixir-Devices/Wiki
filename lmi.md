...
### Installation Guide for DevcieNameHere (Devicecodenamehere)
...
2. Download the Recovery from the link below:
   - **Recovery Link [ For Android 15 ]:** [Recovery](https://www.pling.com/p/1830777/)

3. Download the Project Elixir ROM for from a reliable source.
   - **Project Elixir ROM Link**: [DOWNLOAD](https://projectelixiros.com/device/PocoF2Pro)

4. Download the required Firmware package:
   - **Firmware Link**: [FIRMWARE](https://xmfirmwareupdater.com/firmware/lmi/stable/V14.0.5.0.SJKCNXM/)
...
3. Now tap Wipe, then Format data  and continue with the formatting process.
> [!Warning]
...
5. Tap Install then locate the `Firmware.zip` package
> [!CAUTION]
> Do not reboot before you read/followed the rest of the instructions!
6. Tap Install then locate the `Elixir.zip` package
7. **All set!**
- Once you have installed everything successfully, you can now reboot your device into the OS for the first time!

> [!Important]
> **May Required Files:**
> * Android 15 Recovery Link : [Tap here for link](https://projectelixiros.com/device/PocoF2Pro)
> * Required Firmware : [Tap Here for link](https://xmfirmwareupdater.com/firmware/lmi/stable/V14.0.5.0.SJKCNXM/)
