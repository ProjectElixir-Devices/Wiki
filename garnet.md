...
### Installation Guide for Redmi Note 13 Pro 5G/POCO X6 5G (garnet)
...
2. Download Your Regional Frimware:
   - **Frimware Download Link**: [DOWNLOAD](https://www.xmfirmwareupdater.com/firmware/garnet/)

2. Download the Project Elixir ROM for from a reliable source.
   - **Project Elixir ROM Link**: [DOWNLOAD](https://projectelixiros.com/device/garnet)

3. Download the Recovery from the link below:
   - **Recovery Link [ For Android 16 ]:** [Recovery](https://projectelixiros.com/device/garnet)
...
2. download the latest recovery file, named recovery.img (`.img` file will be in zip) from the link provided in Step 1.
...
### Step 5: Flash Frimware
1. Download the Frimware package that you would like to install
2. If you are not in recovery, reboot into recovery: hold `Volume Up + Power`
...
```
adb  sideload <frimware.zip>
```
6. After the package is installed, recovery will inform you that reboot to recovery to flash the Project Elixir Rom
...
> [!Important]
> **May Required Files:**
> * Android 16 Recovery Link : [Tap here for link](https://projectelixiros.com/download)
